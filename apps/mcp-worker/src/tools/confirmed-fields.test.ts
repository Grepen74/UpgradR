...
describe("assembleCandidateProfile", () => {
  it("returns an empty profile when nothing is confirmed", () => {
    const result = assembleCandidateProfile(
      { headline: "Unconfirmed headline", summary: null, last_reviewed_at: null, is_confirmed: false },
  ...
  it("returns confirmed fields and excludes unconfirmed ones", () => {
    const result = assembleCandidateProfile(
      { headline: "Senior Engineer", summary: "Builds things", last_reviewed_at: "2026-01-01T00:00:00.000Z", is_confirmed: true },
      [
        {
          company: "Acme",
          title: "Engineer",
